var BicycleDrivetrainSVG = (() => {
  ...
  __export(index_exports, {
    BicycleDrivetrainSVG: () => BicycleDrivetrainSVG,
    CassetteSVGGenerator: () => CassetteSVGGenerator,
    ChainSVGGenerator: () => ChainSVGGenerator,
    ChainringSVGGenerator: () => ChainringSVGGenerator,
    DrivetrainSVGGenerator: () => DrivetrainSVGGenerator,
    SprocketGeometry: () => SprocketGeometry,
    calculateCassetteStack: () => calculateCassetteStack,
    calculateDrivetrainLayout: () => calculateDrivetrainLayout,
    default: () => index_default,
    drivetrainPresets: () => drivetrainPresets,
    renderCassetteGroup: () => renderCassetteGroup,
    renderCassetteSvg: () => renderCassetteSvg,
    renderChainSvg: () => renderChainSvg,
    renderChainringSvg: () => renderChainringSvg,
    renderDrivetrainSvg: () => renderDrivetrainSvg,
...
//# sourceMappingURL=bicycle-drivetrain-svg.global.js.map
